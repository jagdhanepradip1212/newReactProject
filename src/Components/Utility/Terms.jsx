...
const Terms = () => {
  return (
    <>
      ...
      {/* Hero End */}
      {/* t&c Start */}
      <section className="section" id="t&c">
        <div className="container">
          <div className="row align-items-start">
            <div className="col-lg-5 col-md-6 col-12">
              <img src="images/app/12.jpg" className="img-fluid" alt="" />
            </div>
            {/*end col*/}
            <div className="col-lg-7 col-md-6 col-12">
              ...
              <p className="text-muted">
                ...
                usually used when a text is requiredely to fill a space. These
              ...
              <ul className="list-unstyled feature-list mb-0 text-muted">
                <li className="h6 fw-normal">
                  <i className="mdi mdi-chevron-double-right me-2" />
